...
<body
    ...
    <div class="container" style="width: 1000px; margin-top: 100px;">
        <div class="card">
            ...
            <div class="container">
                <div>
                    <h5 class="modal-title" id="exampleModalLabel">Diagnosticar tratamiento</h5>
                    <br><br>
                </div>
                <form class="px-4 py-3" action="../controladores/controladorformulario.php" method="post">
                    <div class="container">
                        <div class="wrap">
                            <h5>Agregar Diagnostico</h5>
                    ...
                    <div class="d-flex justify-content-center">
                        <button type="submit" class="btn btn-success" style="text-align: center;" name="operacion"
                            value="guardar12">Guardar</button> &emsp;&emsp;&emsp;

                        <input type="text" name="controlador" value="diagnostico" hidden>
                        <input type="hidden" name="citas_idcita" value="<?php echo $_SESSION['idcita'] ?>" hidden>

                        <!-- <button type="submit" class="btn btn-primary"
                            style="margin-left:90px ; margin-top: 20px;">Editar</button>
                      -->
                    </div>
                </form>
            ...
            <br>
            <div class="d-flex justify-content-center">
                <a href="gestiontratamiento.php" class="btn btn-info" style="text-align: center;">Gestionar
                    tratamiento</a>
            </div>
